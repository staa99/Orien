        ...
        fun localGroupRecyclerViewAdapter(items: ObservableList<Player>)
                         ...
                         R.layout.local_group_list_item)
                {
                    ...
                    init
                    {
                        ...
                        items.addOnListChangedCallback(object :
                                                               ObservableList.OnListChangedCallback<ObservableList<Player>>()
                                                       {
                                                           ...
                                                           {
                                                               s1?.setSelection(
                                                                       s1?.selectedItemPosition
                                                                       ?: 0)
                                                           }

                                                           override fun onItemRangeRemoved(sender: ObservableList<Player>?,
                                                                                           positionStart: Int,
                                                                                           itemCount: Int)
                                                           {
                                                               s1?.setSelection(
                                                           ...
                                                           override fun onItemRangeMoved(sender: ObservableList<Player>?,
                                                                                         fromPosition: Int,
                                                                                         toPosition: Int,
                                                                                         itemCount: Int)
                                                           {
                                                           ...
                                                           override fun onItemRangeInserted(sender: ObservableList<Player>?,
                                                                                            positionStart: Int,
                                                                                            itemCount: Int)
                                                           {
                                                               s1?.setSelection(
                                                           ...
                                                           override fun onItemRangeChanged(sender: ObservableList<Player>?,
                                                                                           positionStart: Int,
                                                                                           itemCount: Int)
                                                           {
                                                               s1?.setSelection(
                    ...
                    override fun onCreateViewHolder(parent: ViewGroup,
                                                    viewType: Int): AppViewHolder<LocalGroupListItemBinding>
                    {
                    ...
                    override fun onBindViewHolder(holder: AppViewHolder<LocalGroupListItemBinding>,
                                                  position: Int)
                    {
